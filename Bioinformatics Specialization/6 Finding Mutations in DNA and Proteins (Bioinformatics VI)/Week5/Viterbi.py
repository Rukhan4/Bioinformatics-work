...
observations = []
with open(r'C:\Users\18687\Desktop\Bio Informatics\Bioinformatics specialization\Finding Mutations in DNA and Proteins (Bioinformatics VI)\chr_22.txt') as f:
    while True:
        c = f.read(1)
        if not c:
            break
...
start_probability = {'A+': 0.125, 'T+': 0.125, 'G+': 0.125,
                     'C+': 0.125, 'A-': 0.125, 'T-': 0.125, 'G-': 0.125, 'C-': 0.125}
